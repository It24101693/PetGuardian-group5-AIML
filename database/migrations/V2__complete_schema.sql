...
-- Flyway migration: Complete PetGuardian schema
...
-- ============================================
-- 5. VACCINATIONS (UPDATE EXISTING)
-- ============================================
...
-- ============================================
-- 6. MEDICAL RECORDS (UPDATE EXISTING)
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_medical_records_pet_date ON medical_records(pet_id, visit_date);
